export const variants = {
  ...
  joy: {
    A: 'ค' /*ᗩ*/, B: 'Ᏸ', C: 'ᑕ', D: 'ᗪ', E: 'Ꮛ', F: 'Ƒ', G: 'Ꮆ', H: 'ⴼ', I: 'ⵊ', J: 'ᑰ', K: 'Ҡ', L: 'Ḻ' /*೭*/, M: 'ᗰ', N: 'ᑎ', O: 'ⵔ', P: 'Ꭾ', Q: 'Ꭴ', R: 'ᖇ', S: 'Ꮥ' /*𐒖*/, T: 'Ͳ', U: 'Ꮼ', V: 'Ꮙ', W: 'Ꮗ', X: 'ⵋ', Y: 'Ꮍ', Z: 'ᘔ',
    a: 'ɑ', b: 'Ⴆ', c: 'ƈ', d: 'ԃ', e: 'ҽ', f: 'ϝ', g: 'ɠ', h: 'Ꮒ', i: 'ἱ', j: 'ʝ', k: 'ƙ', l: 'ℓ', m: 'ɱ', n: 'ຖ', o: '໐', p: 'ρ', q: 'ϙ', r: 'ɾ', s: 'ʂ', t: '৳', u: 'น', v: 'ง', w: 'ຟ', x: 'ϰ', y: 'ყ', z: 'ȥ',
    '0': 'Ø', '1': '⥠', '2': 'ᘖ', '3': 'ჳ', '4': 'ᔰ', '5': 'Ƽ', '6': 'ꕃ', '7': '𐒇', '8': '৪', '9': '𐒘'
  },
  kazad: {
    A: 'ᚤ', B: 'ᛒ', C: 'ᚲ', D: 'ᚦ', E: '𐌄', F: '𐌅', G: 'ᔦ', H: 'ᚺ', I: 'ᛁ', J: 'ᛃ', K: 'ᛕ', L: 'ᖾ', M: 'ᛖ', N: 'ᚾ', O: 'ᛜ', P: 'ᚹ', Q: 'ᛩ', R: 'ᚱ', S: 'ᛊ', T: '	ᛠ', U: '∐', V: '߇', W: 'ᚹ', X: 'ᚷ', Y: 'ᛉ' /*, Z: 'ᛉ',*/
  }
};